import Vidit from "../assets/faculties/Dr Vidit Vats.png"
import Gauravchaturvadi from "../assets/faculties/Mr Gaurav Chaturvedi.png"
...
export const FacultiesData = [
  ...
  },
   {
    ...
    name: 'Prof. M. J. Nigam ',
    image: Nigam,
    title: <p><div>DIRECTOR GENERAL<br></br>RIT ROORKEE</div></p>,
  },
   {
    role: 'CO-PATRON',
...

  {
    ...
    title: <p><div>ASSOCIATE PROFESSOR<br></br>RIT ROORKEE</div></p>,
  },
  {
    role: 'CONFERENCE CHAIR',
    ...
    image: Himanhsugupta,
    title: <p><div>ASSISTANT PROFESSOR<br></br>RIT ROORKEE</div></p>,
  },
     {
    role: 'PUBLICATION CHAIR',
    name: 'Dr. Vidit Vats',
  ...
  },
  {
    ...
    image: Munendra,
    title: <p><div>REGISTRAR<br></br>RIT ROORKEE</div></p>,
  },
